...
function upgradeDogs() {
	if (DogsUpgradeCost <= popsicleNumber )
	{
		Dogs += 1
		DogsCPS += 0.133333333333333333333333333333333333333
		popsiclesSpent += DogsUpgradeCost
		DogsUpgradeCost = Math.ceil(DogsUpgradeCost * 1.15)
	}
}
...
function gameLoop()
{
	...
	document.getElementById("DogsPriceP").innerHTML = "$" + DogsUpgradeCost
}
...
function loadGame()
{
	...
	if (typeof savedGame.DogsCPS !== "undefined"){DogsCPS = savedGame.DogsCPS}
	if (typeof savedGame.Dogs !== "undefined"){Dogs = savedGame.Dogs}
	if (typeof savedGame.DogsUpgradeCost !== "undefined"){DogsUpgradeCost = savedGame.DogsUpgradeCost}
	if (typeof savedGame.DogsClicks !== "undefined"){DogsClicks = savedGame.DogsClicks}
...
function saveGame()
{
	...
	{
		Dogs: Dogs,
		DogsUpgradeCost: DogsUpgradeCost,
		DogsCPS: DogsCPS,
		DogsClicks: DogsClicks,
		SeaGullLevel: SeaGullLevel,
		Name: Name,
